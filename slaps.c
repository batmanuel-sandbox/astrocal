 ...
 ***************************************************************************
 *
 *  slaps - Initialize SLALIB structure for PS1
 */
void slaps(r,d,jd,w,kk,ss)
double r,d,jd,w;
struct key *kk;
struct sla *ss;
{
...
/*
 * Specific to LURE site
 */
	ss->epoch = kk->nomepoch;
	ss->ira = r;
	ss->idec = d;
	ss->mjd = jd;
	ss->olon = -(156.0 + 15.5/60.0)/kk->radian;
	ss->olat = (20.0 + 42.6/60.0)/kk->radian;
	ss->elev = 3049.0;
	ss->temp = 285.0;
